...
public class AdminPostResource {
	...
	public ResponseEntity<PostDTO> updateStatus(@PathVariable Long id, @Valid @RequestBody PostStatusDTO dto) {
		PostDTO updatedDto = adminPostService.updateStatus(id, dto);
		return ResponseEntity.ok().body(updatedDto);
	}
