...
public class BlogService {
	...
	public PostDTO findPostByUrlHandleAndLanguage(String urlHandle, String language) {
		Language lang = Language.valueOf(language.toUpperCase());
		Post post = postRepository.findByContentsUrlHandleAndContentsLanguageAndContentsIsDraftFalse(urlHandle, lang).orElseThrow(() -> new ResourceNotFoundException("Post not found"));
